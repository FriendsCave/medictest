...
SIMPLE_JWT = {
    ...
    "REFRESH_TOKEN_LIFETIME": timedelta(days=7),  # Обновлять токен можно 7 дней
}
...
SECRET_KEY = 'django-insecure-@ndp$_na=e0g4^+9)7w(4v*ewrf&sdls#vr)ce=ax$bcipmb+k'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'medved_db',  # Имя базы данных
        'USER': 'postgres',  # Пользователь (по умолчанию)
        'PASSWORD': '1111',  # Пароль (укажи свой)
